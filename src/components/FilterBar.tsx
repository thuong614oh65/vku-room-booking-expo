...
const EQUIPMENTS: { label: string; value: Equipment }[] = [
  ...
  { label: '??? Máy chi?u', value: 'Projector' },
  { label: '?? Ði?u hòa', value: 'AC' },
    ...
    <View style={styles.container}>
      ...
      {isExpanded && (
        <View style={styles.expandedPanel}>
          ...
          <View style={styles.filterSection}>
            <Text style={styles.filterSectionTitle}>? Trang Thi?t B? Yêu C?u:</Text>
            <View style={styles.chipRow}>
              {EQUIPMENTS.map((eq) => {
          ...
          {hasActiveFilters && (
            <Pressable style={styles.resetBtn} onPress={resetFilters}>
              <Text style={styles.resetBtnText}>?? Ð?t l?i t?t c? b? l?c</Text>
            </Pressable>
          )}
        </View>
      )}
