        ...
        <View style={styles.modalCard}>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.headerTextWrap}>
              <Text style={styles.headerTitle}>Xung Ð?t Khung Gi? Ð?t Phòng</Text>
              <Text style={styles.headerSub}>Gi?i pháp di?u ph?i thông minh cho sinh viên</Text>
            </View>
          ...
          <ScrollView style={styles.bodyScroll} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.alertBox}>
              ...
              <Text style={styles.alertDetail}>
                Khung gi?: <strong>{slot.label}</strong> • Ngày: <strong>{date}</strong>
              </Text>
            </View>
            ...
            {conflict.alternativeRooms && conflict.alternativeRooms.length > 0 && (
              <View style={styles.section}>
                <View style={styles.sectionHeaderRow}>
                  <Text style={styles.sectionTitle}>?? G?i Ý Phòng Tuong Ðuong Còn Tr?ng:</Text>
                  <Text style={styles.sectionBadge}>Cùng gi? {slot.label}</Text>
                </View>
                <Text style={styles.sectionDesc}>
                  H? th?ng t? d?ng tìm th?y các phòng cùng tòa nhà ho?c cùng s?c ch?a dang tr?ng:
                </Text>
                ...
                {conflict.alternativeRooms.map((altRoom) => (
                  ...
                  >
                    ...
                    <View style={styles.selectAltBtn}>
                      <Text style={styles.selectAltBtnText}>Ð?i Sang Phòng Này ?</Text>
                    </View>
                  </Pressable>
                ))}
              </View>
            ...
            {conflict.alternativeSlots && conflict.alternativeSlots.length > 0 && (
              <View style={styles.section}>
                <Text style={styles.sectionTitle}>? Khung Gi? Khác Còn Tr?ng Trong Ngày:</Text>
                <Text style={styles.sectionDesc}>
                  N?u b?n v?n uu tiên phòng này, hãy ch?n các ca h?c lân c?n:
                </Text>
            ...
            <View style={styles.waitlistCard}>
              <View style={styles.waitlistHeader}>
                ...
                <View style={styles.waitlistTextWrap}>
                  <Text style={styles.waitlistTitle}>Hàng Ð?i Nh?n Thông Báo (Waitlist)</Text>
                  <Text style={styles.waitlistSub}>
                    Uu tiên thông báo d?y ngay l?p t?c n?u b?n d?t tru?c h?y phòng
                  </Text>
                </View>
              </View>
              <Pressable
              ...
              >
                <Text style={[styles.waitlistBtnText, inWaitlist && styles.waitlistBtnTextActive]}>
                  {inWaitlist ? '? Ðã trong danh sách ch? nh?n tin' : 'Ðang ký vào Hàng Ð?i Uu Tiên'}
                </Text>
              </Pressable>
            </View>
          </ScrollView>
          ...
          <View style={styles.footer}>
            <Pressable style={styles.dismissBtn} onPress={onClose}>
              <Text style={styles.dismissBtnText}>Ðóng & Quay l?i</Text>
            </Pressable>
          </View>
        </View>
      </View>
