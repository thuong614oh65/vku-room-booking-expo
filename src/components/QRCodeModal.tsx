      ...
      <View style={styles.overlay}>
        <View style={styles.modalCard}>
          <View style={styles.header}>
            <Text style={styles.headerTitle}>Th? Thông Hành Check-in Phòng</Text>
          ...
          <View style={styles.ticketCard}>
            <View style={styles.ticketHeader}>
              <Text style={styles.schoolName}>Ð?I H?C CÔNG NGH? THÔNG TIN & TRUY?N THÔNG VI?T - HÀN</Text>
            ...
            <View style={styles.qrDisplayBox}>
              ...
              <Text style={styles.qrScanHint}>Ðua mã này vào máy quét t?i c?a phòng d? m? khóa</Text>
            </View>

            {/* Details */}
            <View style={styles.detailsGrid}>
              <View style={styles.detailItem}>
                <Text style={styles.detailLabel}>PHÒNG H?C</Text>
                <Text style={styles.detailValue} numberOfLines={1}>{booking.roomName}</Text>
              </View>
              <View style={styles.detailItem}>
                <Text style={styles.detailLabel}>Ð?A ÐI?M</Text>
              ...
              <View style={styles.detailItem}>
                <Text style={styles.detailLabel}>NGÀY S? D?NG</Text>
                <Text style={styles.detailValue}>{booking.date}</Text>
              </View>
              <View style={styles.detailItem}>
                <Text style={styles.detailLabel}>SINH VIÊN Ð?T</Text>
                <Text style={styles.detailValue}>{booking.studentName} ({booking.studentId})</Text>
              </View>
              <View style={styles.detailItem}>
                <Text style={styles.detailLabel}>TR?NG THÁI</Text>
                <Text style={[styles.detailValue, isCheckedIn ? styles.statusChecked : styles.statusConfirmed]}>
                  {isCheckedIn ? '? ÐÃ CHECK-IN' : '?? S?N SÀNG VÀO PHÒNG'}
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.actionRow}>
            {!isCheckedIn && (
              ...
              >
                <Text style={styles.checkInBtnText}>?? Quét Check-In M? C?a</Text>
              </Pressable>
            )}
            <Pressable style={styles.dismissBtn} onPress={onClose}>
              <Text style={styles.dismissBtnText}>Ðóng</Text>
            </Pressable>
          </View>
        </View>
      </View>
